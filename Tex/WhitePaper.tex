...
%\begin{table}[h!b!p!]\footnotesize
%\centering
%\vspace{10pt}
%\caption{Summary  for Shopper Segmentations from K means clustering using the sample test sets.}
%\begin{tabular}{l*{5}{c}r}
%\hline
%Cluster & Number of Customers & Avg. Transaction Frequency & Avg. Number of ZIP &  Avg. Number of Merchant \\
%\hline
%1	&14797	&465 	&33 &	39\\
%2	&30261	&472 	&65	&57\\
%3	&22981	&513 	&92 &	73\\
...
%\centering
%\vspace{10pt}
%\caption{Summary for customers in the validation set classified into the predefined clusters from K-means clustering }
%\begin{tabular}{l*{5}{c}r}
%\hline
%Cluster & Number of Customers & Avg. Transaction Frequency & Avg. Number of ZIP &  Avg. Number of Merchant \\
%\hline
